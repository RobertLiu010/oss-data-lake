...
- [§9. 智能引擎（Intelligent Engine）](#9-智能引擎intelligent-engine)
  ...
  - [§9.5 VFS MCP Server（向 LLM 暴露 Lake）](#95-vfs-mcp-server向-llm-暴露-lake)
...
| 场景 | 检测 | 解决 |
| --- | --- | --- |
| **同一 Entity 并发 Raw 写入** | RepPipeline-level 锁（§6.9.2） | Last-writer-wins，Reconciler 兜底 |
